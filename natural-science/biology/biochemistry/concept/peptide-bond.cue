...
peptide_bond: {
  content: #"""
    The peptide bond exhibits a large dipole moment in the favored trans
    configuration (dipole moment is a measure of the *separation of positive
    ...
    bonds in the backbone may also be rotationally hindered, depending on the
    size and charge of $"R"$ group.
  """#
}